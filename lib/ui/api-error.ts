 ...
 *
 * Every admin-panel form keys its error copy off this `code`, never off the
 * server's own sentence (docs/DESIGN-SYSTEM.md § Voice & tone; mirrors
 * `components/PasswordGate.tsx`'s own `codeOf`).
 */
