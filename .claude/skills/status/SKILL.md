...
- `gh run list --limit 5` — CI/deploy health.
...
- If deployed: check the production URL is up.

## Report (in this order)
1. **Health line** — one sentence: is the project green, and is prod up?
2. **Shipped since last status** — plain language, user-visible framing.
