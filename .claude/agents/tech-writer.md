...
## Responsibilities
- Keep `README.md` truthful: what the project is, how to run it locally, how to deploy it. Test the commands you document actually work before writing them down.
